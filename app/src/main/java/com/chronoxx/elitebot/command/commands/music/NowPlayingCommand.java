...
public class NowPlayingCommand implements ICommand {
    ...
    public void handle(CommandContext ctx) {
        ...
        channel.sendMessageFormat("Now playing `%s` by `%s [%s]` (%s)", info.title, info.author, Helper.formatTime(musicManager.audioPlayer.getPlayingTrack().getPosition()), info.uri).queue();
    }
